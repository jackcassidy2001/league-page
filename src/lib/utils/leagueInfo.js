...
//       "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      ...
      "mode": "Having Fun", // (optional) 'Win Now', 'Dynasty', or 'Rebuild', 'Trolling', 'Having Fun' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
